...
function loadMenuItems() {
	...
	// Purchase Supplies
	menuItem = new Object();
	menuItem.id = "purchaseSupplies";
	menuItem.text = "PURCHASE SUPPLIES"
	menuItem.iconStyleClass = "fa fa-usd";
	menuItems.push(menuItem);
	...
	menuItem.id = "items";
	menuItem.text = "ITEMS"
	menuItem.iconStyleClass = "fa fa-shopping-cart";
	menuItems.push(menuItem);

	// Supplier
	menuItem = new Object();
	menuItem.id = "supplier";
	menuItem.text = "SUPPLIERS"
	menuItem.iconStyleClass = "fa fa-user-plus";
	menuItems.push(menuItem);
	
	// Supplier
	menuItem = new Object();
	menuItem.id = "suppliers_copy";
	menuItem.text = "test"
	menuItem.iconStyleClass = "fa fa-user-plus";
	menuItems.push(menuItem);
